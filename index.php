...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">Pari@gmail.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+919042711174</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">PARI <span>KING</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+919042711174</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">Pari@gmail</a></p>
			<p class="contact-agile1"><strong>Address :</strong> bengalore</p>
